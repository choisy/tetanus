...
* there is 2 sample (0.4 %) for which a dilution of 50 is already too much in order to
estimate the lower bound of its 95% confidence interval;
* there are 26 samples (5.4 %) for which a dilution of 200 is not enough in order to do
any estimation of the concentration.
